...
Thank you for your interest in contributing to the tech-learning-resources repository! We are looking for additional learning resources to add to our expanding list.
...
3. In the command line, clone the repository by typing `git clone https://github.com/YOUR-GITHUB-USERNAME/tech-learning-resources.git`
4. Then type `cd tech-learning-resources` to go into the project's directory.
5. Create a branch and switch to that new branch by using the following command: `git checkout -b new-branch-name`
6. Update the `README.md` with your resource suggestion(s).
   - Append the title and link to the resource, to the list in the appropriate category
